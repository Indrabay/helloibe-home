        ...
        <Stack hideBelow={'md'} direction={'column'} justifyContent={'space-between'}>
          <Stack direction={'row'}>
            <Stack direction={'column'} justifyContent={'center'}>
              <Text textTransform={'uppercase'} color={'white'} textStyle={{ lg: '4xl', md: '3xl', sm: '2xl' }}><Mark color={'var(--color-primary)'}>{'>'}</Mark> Hello, ibe is <Mark color={'var(--color-primary)'}>me</Mark></Text>
